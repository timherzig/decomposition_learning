...
from src.models.decomposer import Decomposer
...
class UNet_conditional(nn.Module):
    def __init__(
        ...
        # Condition on embeddings generated by the decomposer
        self.decomposer = Decomposer(self.decomposer_config)  # --- (B, C, N, H, W)
        self.decomposer = self.decomposer.swin()
        # # For 256x256 images
    ...
    def conditioning_encoding(self, conditioning_images):
        ...
        x = self.decomposer(conditioning_images)
