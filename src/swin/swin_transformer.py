'''
Directly taken from the Video Swin Transformer implementation on GitHub:
https://github.com/SwinTransformer/Video-Swin-Transformer/blob/master/mmaction/models/backbones/swin_transformer.py#L654
'''
